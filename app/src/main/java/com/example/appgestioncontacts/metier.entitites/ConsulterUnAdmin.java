...
public class ConsulterUnAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulter_un_admin);
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Administrateur e=met.ConsulterAdminById(Integer.parseInt(s));
        ...
        btnM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                met.UpdateAdmin(code.getText().toString(),txtNom.getText().toString()
        ...
        btnD.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                met.DeleteAdmin(code.getText().toString());
                txtNom.setText("");
                txtPrenom.setText("");
                txtAdress.setText("");
                txtTel.setText("");
